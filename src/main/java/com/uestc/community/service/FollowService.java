...
public class FollowService {
    ...
    // 查询某用户收藏的帖
    public List<Map<String, Object>> findFavorite(int userId, int offset, int limit) {
        ...
        for (Integer targetId : targetIds) {
            ...
            map.put("post", post);
            long likeCount = likeService.findEntityLikeCount(ENTITY_TYPE_POST,targetId);
            map.put("likeCount",likeCount);
            Double score = redisTemplate.opsForZSet().score(followeeKey, targetId);
            map.put("favoriteTime", new Date(score.longValue()));
            list.add(map);
        }
